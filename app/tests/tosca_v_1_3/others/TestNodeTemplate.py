...
from app.parser.tosca_v_1_3.others.NodeTemplate import node_template_parser
...
class TestNodeTemplate(unittest.TestCase):
    ...
    def test_template(self):
        ...
        for name, value in data.items():
            ...
            for capabilities_name, capabilities_value in node.node_filter.capabilities.items():
