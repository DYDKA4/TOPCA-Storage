...
from parser.tests.tosca_v_1_3.types import TestCapability, TestData, TestGroup, TestPolicy, TestRelationship
from parser.tests.tosca_v_1_3.types import TestNode, TestInterface, TestArtifact
