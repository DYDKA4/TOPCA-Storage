...
from mariadb_parser.ORM_model.DataBase import Type, DependencyTypes
...
Type(id=1,
     ...
     type_name='tosca.datatypes.Root',
     data="{\"description\": \"The TOSCA root Data Type all other TOSCA base Data Types derive from\\n\"}")
