...
from parser_nebula.parser.tosca_v_1_3.definitions.ActivityDefinition import activity_definition_parser
from parser_nebula.parser.tosca_v_1_3.definitions.ConditionClauseDefinition import condition_clause_definition_parser, \
