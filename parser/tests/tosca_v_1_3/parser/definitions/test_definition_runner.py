...
from parser.tests.tosca_v_1_3.parser.definitions import TestPolicy
from parser.tests.tosca_v_1_3.parser.definitions import TestOperation, TestInterface, TestDescription, TestProperty, \
    ...
    TestConditionClause
from parser.tests.tosca_v_1_3.parser.definitions import TestArtifact, TestImperativeWorkflow, TestPropertyFilter
