...
from parser.tests.tosca_v_1_3.parser.types import TestCapability, TestData, TestGroup, TestPolicy, TestRelationship
from parser.tests.tosca_v_1_3.parser.types import TestNode, TestInterface, TestArtifact
