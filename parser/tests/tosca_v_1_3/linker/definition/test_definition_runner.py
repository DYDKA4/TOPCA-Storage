...
from parser.tests.tosca_v_1_3.linker.definition import test_link_artifact_definition, \
    ...
    test_link_group_definition, test_link_interface_definition
...
def test_definition_runner():
    ...
    assignmentTestSuite.addTest(unittest.makeSuite(test_link_interface_definition.TestAttributeDefinition))
