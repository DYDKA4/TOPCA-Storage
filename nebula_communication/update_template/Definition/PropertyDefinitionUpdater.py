...
def update_property_definition(service_template_vid, father_node_vid, value, value_name, varargs: list):
    if len(varargs) < 2:
        abort(400)
    ...
    if len(varargs) == 2:
        ...
        update_constraint_clause(property_vid_to_update, value, value_name, varargs[2:])
