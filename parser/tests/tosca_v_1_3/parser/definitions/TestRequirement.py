...
from parser.parser.tosca_v_1_3.definitions.RequirementDefinition import requirement_definition_parser
...
class TestRequirement(unittest.TestCase):
    ...
    def test_short_notation(self):
        ...
        for name, value in data.items():
            ...
            self.assertEqual(requirement.relationship_type_name, None)
    ...
    def test_extended_grammar(self):
        ...
        for name, value in data.items():
            ...
            self.assertEqual(requirement.relationship_type_name, 'test_relationship_type_name')
            self.assertEqual(requirement.interfaces, [])
